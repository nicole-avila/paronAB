 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul=new Map,Ah=new Map;function fA(t,e){try{t.container.addComponent(e)}catch(n){vr.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function _i(t){const e=t.name;if(Ah.has(e))return vr.debug(`There were multiple attempts to register component ${e}.`),!1;Ah.set(e,t);for(const n of ul.values())fA(n,t);return!0}function Jd(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi=hA;function Ev(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Sh,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw Mn.create("bad-app-name",{appName:String(i)});if(n||(n=gv()),!n)throw Mn.create("no-options");const s=ul.get(i);if(s){if(ll(n,s.options)&&ll(r,s.config))return s;throw Mn.create("duplicate-app",{appName:i})}const o=new IS(i);for(const l of Ah.values())o.addComponent(l);const a=new mA(n,r,o);return ul.set(i,a),a}function wv(t=Sh){const e=ul.get(t);if(!e&&t===Sh&&gv())return Ev();if(!e)throw Mn.create("no-app",{appName:t});return e}function Fn(t,e,n){var r;let i=(r=dA[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),vr.warn(a.join(" "));return}_i(new _r(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gA="firebase-heartbeat-database",yA=1,Hs="firebase-heartbeat-store";let lc=null;function Tv(){return lc||(lc=MS(gA,yA,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Hs)}}}).catch(t=>{throw Mn.create("idb-open",{originalErrorMessage:t.message})})),lc}async function _A(t){try{return await(await Tv()).transaction(Hs).objectStore(Hs).get(Iv(t))}catch(e){if(e instanceof hn)vr.warn(e.message);else{const n=Mn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});vr.warn(n.message)}}}async function Cm(t,e){try{const r=(await Tv()).transaction(Hs,"readwrite");await r.objectStore(Hs).put(e,Iv(t)),await r.done}catch(n){if(n instanceof hn)vr.warn(n.message);else{const r=Mn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});vr.warn(r.message)}}}function Iv(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class If{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.oe(r),this._e=r=>n.writeSequenceNumber(r))}oe(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this._e&&this._e(e),e}}If.ae=-1;function cu(t){return t==null}function yl(t){return t===0&&1/t==-1/0}function KR(t){return typeof t=="number"&&Number.isInteger(t)&&!yl(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sf(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Af(t){const e=t.mapValue.fields.__previous_value__;return Sf(e)?Af(e):e}function eo(t){const e=Bn(t.mapValue.fields.__local_write_time__.timestampValue);return new we(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,n="asc"){this.field=e,this.dir=n}}function XR(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B0(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:yl(e)?"-0":e}}function z0(t){return{integerValue:""+t}}function vC(t,e){return KR(e)?z0(e):B0(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fP{constructor(){this.Ui=!1,this.Wi=!1,this.Gi=100,this.zi=8}initialize(e,n){this.ji=e,this.indexManager=n,this.Ui=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Hi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Ji(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new dP;return this.Yi(e,n,o).next(a=>{if(s.result=a,this.Wi)return this.Zi(e,n,o,a.size)})}).next(()=>s.result)}Zi(e,n,r,i){return r.documentReadCount<this.Gi?(Ji()<=q.DEBUG&&D("QueryEngine","SDK will not create cache indexes for query:",Mr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Gi,"documents"),I.resolve()):(Ji()<=q.DEBUG&&D("QueryEngine","Query:",Mr(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.zi*i?(Ji()<=q.DEBUG&&D("QueryEngine","The SDK decides to create cache indexes for query:",Mr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,$t(n))):I.resolve())}Hi(e,n){if(Zm(n))return I.resolve(null);let r=$t(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Bh(n,null,"F"),r=$t(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=H(...s);return this.ji.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.Xi(n,a);return this.es(n,u,o,l.readTime)?this.Hi(e,Bh(n,null,"F")):this.ts(e,u,n,l)}))})))}Ji(e,n,r,i){return Zm(n)||i.isEqual($.min())?I.resolve(null):this.ji.getDocuments(e,r).next(s=>{const o=this.Xi(n,s);return this.es(n,o,r,i)?I.resolve(null):(Ji()<=q.DEBUG&&D("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Mr(n)),this.ts(e,o,n,BR(i,-1)).next(a=>a))})}Xi(e,n){let r=new He(U0(e));return n.forEach((i,s)=>{fu(e,s)&&(r=r.add(s))}),r}es(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Yi(e,n,r){return Ji()<=q.DEBUG&&D("QueryEngine","Using full collection scan to execute query:",Mr(n)),this.ji.getDocumentsMatchingQuery(e,n,bn.min(),r)}ts(e,n,r,i){return this.ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class us{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class bE extends $E{constructor(e,n,r,i,s,o){super(e,n,r,i,o),this._firestore=e,this._firestoreImpl=e,this.metadata=s}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new ka(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const r=this._document.data.field(jE("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,n.serverTimestamps)}}}class ka extends bE{data(e={}){return super.data(e)}}class Nk{constructor(e,n,r,i){this._firestore=e,this._userDataWriter=n,this._snapshot=i,this.metadata=new us(i.hasPendingWrites,i.fromCache),this.query=r}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(r=>{e.call(n,new ka(this._firestore,this._userDataWriter,r.key,r,new us(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new V(T.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(i,s){if(i._snapshot.oldDocs.isEmpty()){let o=0;return i._snapshot.docChanges.map(a=>{const l=new ka(i._firestore,i._userDataWriter,a.doc.key,a.doc,new us(i._snapshot.mutatedKeys.has(a.doc.key),i._snapshot.fromCache),i.query.converter);return a.doc,{type:"added",doc:l,oldIndex:-1,newIndex:o++}})}{let o=i._snapshot.oldDocs;return i._snapshot.docChanges.filter(a=>s||a.type!==3).map(a=>{const l=new ka(i._firestore,i._userDataWriter,a.doc.key,a.doc,new us(i._snapshot.mutatedKeys.has(a.doc.key),i._snapshot.fromCache),i.query.converter);let u=-1,c=-1;return a.type!==0&&(u=o.indexOf(a.doc.key),o=o.delete(a.doc.key)),a.type!==1&&(o=o.add(a.doc),c=o.indexOf(a.doc.key)),{type:xk(a.type),doc:l,oldIndex:u,newIndex:c}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function xk(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return F()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Al=new Yd("@firebase/auth");function Fk(t,...e){Al.logLevel<=q.WARN&&Al.warn(`Auth (${Oi}): ${t}`,...e)}function Na(t,...e){Al.logLevel<=q.ERROR&&Al.error(`Auth (${Oi}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Gk(t,e=!1){const n=Ve(t),r=await n.getIdToken(e),i=Zf(r);M(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:As(wc(i.auth_time)),issuedAtTime:As(wc(i.iat)),expirationTime:As(wc(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function wc(t){return Number(t)*1e3}function Zf(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return Na("JWT malformed, contained fewer than 3 sections"),null;try{const i=pv(n);return i?JSON.parse(i):(Na("Failed to decode base64 JWT payload"),null)}catch(i){return Na("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function Qk(t){const e=Zf(t);return M(e,"internal-error"),M(typeof e.exp<"u","internal-error"),M(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oo(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof hn&&Yk(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function Yk({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){M(e.idToken,"internal-error"),M(typeof e.idToken<"u","internal-error"),M(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Qk(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}async getToken(e,n=!1){return M(!this.accessToken||this.refreshToken,e,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await tN(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,o=new ao;return r&&(M(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),i&&(M(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(M(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new ao,this.toJSON())}_performRefresh(){return Xt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AN(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function RN(t){const e=rs(is(t)).link,n=e?rs(is(e)).deep_link_id:null,r=rs(is(t)).deep_link_id;return(r?rs(is(r)).link:null)||r||n||e||t}class np{constructor(e){var n,r,i,s,o,a;const l=rs(is(e)),u=(n=l.apiKey)!==null&&n!==void 0?n:null,c=(r=l.oobCode)!==null&&r!==void 0?r:null,h=AN((i=l.mode)!==null&&i!==void 0?i:null);M(u&&c&&h,"argument-error"),this.apiKey=u,this.operation=h,this.code=c,this.continueUrl=(s=l.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=l.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=l.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=RN(e);try{return new np(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PN(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await oo(t,uw(r,i,e,t),n);M(s.idToken,r,"internal-error");const o=Zf(s.idToken);M(o,r,"internal-error");const{sub:a}=o;return M(t.uid===a,r,"user-mismatch"),Sr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&Nt(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rx="pendingRedirect",Da=new Map;class ix extends Ew{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Da.get(this.auth._key());if(!e){try{const r=await sx(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Da.set(this.auth._key(),e)}return this.bypassAuthState||Da.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function sx(t,e){const n=lx(e),r=ax(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function ox(t,e){Da.set(t._key(),e)}function ax(t){return Jt(t._redirectPersistence)}function lx(t){return xa(rx,t.config.apiKey,t.name)}async function ux(t,e,n=!1){const r=Or(t),i=JN(r,e),o=await new ix(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hx=5*60,Wx=yv("authIdTokenMaxAge")||Hx;let $g=null;const qx=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Wx)return;const i=n==null?void 0:n.token;$g!==i&&($g=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Kx(t=wv()){const e=Jd(t,"auth");if(e.isInitialized())return e.getImmediate();const n=gN(t,{popupRedirectResolver:jx,persistence:[XN,$N,mw]}),r=yv("authTokenSyncURL");if(r){const s=qx(r);ON(n,s,()=>s(n.currentUser)),DN(n,o=>s(o))}const i=mv("auth");return i&&_N(n,`http://${i}`),n}zx("Browser");const Gx={apiKey:"AIzaSyCRVpVqEOJXuHQ12qULNzSfa7VMJ-k-QEc",authDomain:"paron-project.firebaseapp.com",projectId:"paron-project",storageBucket:"paron-project.appspot.com",messagingSenderId:"881222413608",appId:"1:881222413608:web:d8b7e533c762cc92d7741d"},Tw=Ev(Gx),ci=_k(Tw),Ci=Kx(Tw);function Qx(){const[t,e]=A.useState([]),[n,r]=A.useState(!0),i=so(ci,"stockList");return A.useEffect(()=>{try{async function s(){await Sl(i),r(!1)}s()}catch(s){console.log("error",s)}},[]),A.useEffect(()=>{try{async function s(){const o=await Sl(i);e(o.docs.map(a=>({...a.data()})))}s(),console.log(t)}catch(s){console.log("error",s)}},[]),v.jsxs("div",{className:"stock",children:[v.jsx("h1",{className:"stock__title",children:"Lagersaldo"}),v.jsx("div",{className:"stock__container",children:n?v.jsx("p",{className:"stock__loading",children:"Loading..."}):v.jsx(v.Fragment,{children:Array.isArray(t)&&t.map((s,o)=>v.jsx("div",{className:"stock__section",children:v.jsxs("div",{children:[v.jsx("div",{className:"stock__section-top",children:v.jsx("h1",{className:"stock__warehouse-title",children:s.warehouse})}),v.jsx("div",{className:"stock__products-container",children:s.products.map((a,l)=>v.jsx("div",{className:"stock__product-box",children:v.jsxs("div",{className:"stock__product-text",children:[v.jsx("p",{className:"stock__product-name",children:a.productName}),v.jsxs("p",{className:"stock__product-quantity",children:[a.quantity," st"]})]})},l))})]})},o))})})]})}const Iw="/paronAB/assets/profile-icon-ace2a945.svg";function jg({authUser:t}){return v.jsx("div",{className:"home",children:t?v.jsxs("div",{children:[v.jsxs("div",{className:"home__profile",children:[v.jsx("img",{src:Iw,className:"home__profile-icon",alt:""}),v.jsx("p",{className:"home__auth-user",children:`${t.email}`})]}),v.jsx(Qx,{})]}):v.jsx("div",{className:"home-hero",children:v.jsxs("h1",{className:"home__hero-title",children:["Päron ",v.jsx("span",{className:"home__title-ab",children:"Ab"})]})})})}function Yx(){const[t,e]=A.useState(""),[n,r]=A.useState(""),[i,s]=A.useState(""),[o,a]=A.useState("signup"),l=yo();function u(c){if(c.preventDefault(),n.length<6){s("Lösenordet måste innehålla minst 6 tecken");return}NN(Ci,t,n).then(h=>{console.log(h),l("/paronAb/home")}).catch(h=>{console.log(h)})}return v.jsx("div",{className:"auth",children:o==="signup"?v.jsxs("div",{className:"auth__container",children:[v.jsx("div",{className:"auth__profile",children:v.jsx("h1",{children:"Skapa ett konto"})}),v.jsxs("form",{onSubmit:u,className:"auth__form",children:[v.jsx("input",{type:"email",placeholder:"email",value:t,onChange:c=>e(c.target.value),onClick:()=>s("")}),v.jsx("input",{type:"password",placeholder:"password",value:n,onChange:c=>{r(c.target.value),s("")}}),v.jsx("p",{className:"auth__password-text",children:i}),v.jsx("button",{className:"auth__signup-btn",children:"Skapa konto"})]}),v.jsx("button",{onClick:()=>a("login"),className:"auth__login-btn",children:"logga in"})]}):v.jsx(Sw,{})})}function Sw(){const[t,e]=A.useState(""),[n,r]=A.useState(""),[i,s]=A.useState(""),[o,a]=A.useState("login"),l=yo();function u(c){c.preventDefault(),xN(Ci,t,n).then(h=>{console.log(h),l("/paronAB/")}).catch(h=>{console.log(h),s("Inloggningen misslyckades, försök igen")})}return v.jsx("div",{className:"auth",children:o==="login"?v.jsxs("div",{className:"auth__container",children:[v.jsxs("div",{className:"auth__profile",children:[v.jsx("img",{src:Iw,alt:""}),v.jsx("h1",{children:"Logga in"})]}),v.jsxs("form",{onSubmit:u,className:"auth__form",children:[v.jsx("input",{type:"email",placeholder:"email",value:t,onChange:c=>e(c.target.value),onClick:()=>{s(""),r("")}}),v.jsx("input",{type:"password",placeholder:"password",value:n,onChange:c=>r(c.target.value)}),v.jsx("p",{className:"auth__login-message",children:i}),v.jsx("button",{className:"auth__login",children:"logga in"})]}),v.jsxs("p",{onClick:()=>a("signup"),className:"auth__signup-text",children:[" ",v.jsx("u",{children:"skapa ett konto"})," "]})]}):v.jsx(Yx,{})})}function Xx({warehouse:t,setWarehouse:e,products:n,setProducts:r,stocks:i,setMessage:s}){return v.jsx("div",{children:v.jsxs("div",{className:"update__form",children:[v.jsxs("select",{id:"warehouse",value:t,onChange:o=>e(o.target.value),onClick:()=>s(""),children:[v.jsx("option",{value:"#",children:"välj varulager"}),i.map((o,a)=>v.jsx("option",{value:o.warehouse,children:o.warehouse},a))]}),v.jsxs("select",{id:"product",value:n.productName,onChange:o=>r({...n,productName:o.target.value}),children:[v.jsx("option",{value:"#",children:"välj produkt"}),i.filter(o=>o.warehouse===t).map((o,a)=>o.products.map((l,u)=>v.jsx("option",{value:l.productName,children:l.productName},u)))]}),v.jsx("br",{}),v.jsx("label",{htmlFor:"quantity",children:"Skriv in antal enheter"}),v.jsx("input",{type:"number",id:"quantity",placeholder:"antal enheter...",value:n.quantity,onChange:o=>r({...n,quantity:o.target.value})})]})})}function Jx(){const[t,e]=A.useState(""),[n,r]=A.useState({productName:"",quantity:""}),[i,s]=A.useState([]),[o,a]=A.useState(""),l=so(ci,"stockList"),u=so(ci,"updatedHistory");A.useEffect(()=>{try{async function h(){const d=await Sl(l);console.log(d),s(d.docs.map(m=>({...m.data(),id:m.id})))}h()}catch(h){console.log("error",h)}},[]);async function c(h,d,m){if(t&&n.productName&&n.quantity)try{const y=xE(ci,"stockList",h);console.log(y);const _=await Dk(y);if(console.log(_),_.exists()){const w=_.data();console.log(w),console.log(w.products);const p=Number(m),f=w.products.map(E=>E.productName===d?{...E,quantity:p}:E);console.log(p),console.log(f);const g={...w,products:f};await Ok(y,g),await zE(u,{updatedData:g}),console.log(u),e(""),r({productName:"",quantity:""}),a("Lyckad Uppdatering!"),console.log("antalet i podukten är uppdaterad")}}catch(y){console.log("något fel inträffa",y)}}return v.jsxs("div",{className:"update",children:[v.jsx("h1",{className:"update__title",children:"Uppdatera Lagersaldo"}),v.jsx(Xx,{warehouse:t,setWarehouse:e,products:n,setProducts:r,stocks:i,setMessage:a}),v.jsxs("div",{className:"update__btn-container",children:[v.jsx("button",{className:"update__add-btn",onClick:()=>{const h=i.find(d=>d.warehouse===t);c(h.id,n.productName,n.quantity)},children:"Lägg till"}),v.jsx("button",{className:"update__remove-btn",children:"Ta bort"})]}),v.jsx("p",{className:"update__message",children:o})]})}function Zx(){return v.jsx("div",{className:"UpdateStock",children:v.jsx(Jx,{})})}function eD(){const[t,e]=A.useState(""),[n,r]=A.useState([{productName:"",quantity:""}]),[i,s]=A.useState(""),o=so(ci,"stockList"),[a,l]=A.useState(!1);function u(d){d.preventDefault(),r([...n,{productName:"",quantity:""}]),console.log(n)}A.useEffect(()=>{console.log(n)},[n]);async function c(d){if(d.preventDefault(),l(!0),t&&n.length>0){try{await zE(o,{warehouse:t,products:n,author:{email:Ci.currentUser.email,id:Ci.currentUser.uid}}),e(""),r([{productName:"",quantity:""}]),s("sparat!"),console.log("produkten är tilllagd")}catch(m){console.error("något fel inträffa",m)}l(!1)}}function h(d,m){const{name:y,value:_}=d.target;r(w=>{const p=[...w];return p[m]={...p[m],[y]:y==="quantity"?Number(_):_},p})}return v.jsxs("div",{className:"create",children:[v.jsx("p",{children:i}),v.jsx("span",{children:"Lägg till ett färdigvarulager"}),v.jsx("input",{className:"create__input",type:"text",id:"warehouse",value:t,onChange:d=>e(d.target.value),onClick:()=>s("")}),v.jsx("div",{className:"create__container",children:n.map((d,m)=>v.jsxs("div",{children:[v.jsx("label",{htmlFor:"productName",children:"Produkt"}),v.jsx("input",{className:"create__input",type:"text",placeholder:"add product..",name:"productName",value:d.productName,onChange:y=>h(y,m)}),v.jsx("label",{htmlFor:"quantity",children:"Antal enheter"}),v.jsx("input",{className:"create__input",type:"text",placeholder:"add quantity..",name:"quantity",value:d.quantity,onChange:y=>h(y,m)})]},m))}),v.jsx("button",{onClick:u,className:"create__add-produkt-btn",children:"lägg till en ny produkt"}),v.jsx("button",{onClick:c,className:"create__save-btn",disabled:a,children:a?"invänta sparandet":"spara"})]})}function tD(){return v.jsxs("div",{className:"create",children:[v.jsx("h1",{children:"Skapa nytt"}),v.jsx(eD,{})]})}function nD(){const[t,e]=A.useState([]),n=so(ci,"updatedHistory");return A.useEffect(()=>{try{async function r(){const i=await Sl(n);console.log(i),e(i.docs.map(s=>({...s.data()}))),console.log(t)}r()}catch(r){console.log("error",r)}},[]),v.jsx("div",{children:Array.isArray(t)&&t.map((r,i)=>(console.log(r),v.jsx("div",{children:v.jsx("h5",{children:"Author"})},i)))})}function rD(){return v.jsxs("div",{className:"History",children:[v.jsx("h1",{children:"History"}),v.jsx(nD,{})]})}function iD(){const t=yo();function e(){LN(Ci).then(()=>{console.log("Sign out successful"),t("/paronAB/")}).catch(n=>console.log(n))}return v.jsx("div",{children:v.jsx("button",{onClick:e,className:"app__logout-btn",children:"Logga ut"})})}function sD(){const[t,e]=A.useState(!1);function n(){e(!1)}return v.jsxs("div",{className:"navbar",children:[v.jsx("div",{className:`navbar__toggle ${t&&"navbar__open"}`,onClick:()=>e(!t),children:v.jsx("div",{className:"navbar__bar"})}),v.jsxs("div",{className:`navbar__items ${t&&"navbar__open"}`,children:[v.jsx(Aa,{to:"/paronAB/",onClick:n,children:"Home"}),v.jsx(Aa,{to:"/paronAB/create-stock",onClick:n,children:"Skapa"}),v.jsx(Aa,{to:"/paronAB/update-stock",onClick:n,children:"Uppdatera Saldo"})]})]})}function bg(){const[t,e]=A.useState(!0),n=yo(),r=go();return A.useEffect(()=>{e(r!=="/paronAB/")},[r]),v.jsx("div",{className:"logo",children:t&&v.jsxs("h4",{onClick:()=>n("/paronAB/"),className:"logo__title",children:["päron ",v.jsx("span",{children:"ab"})]})})}function oD(){const[t,e]=A.useState(null);return A.useEffect(()=>{VN(Ci,n=>{e(n||null)})},[]),v.jsx("div",{className:"app",children:v.jsxs(KI,{children:[v.jsx("nav",{children:t?v.jsxs("div",{className:"app__navbar-container",children:[v.jsxs("div",{className:"app__navbar",children:[v.jsx(bg,{}),v.jsx(sD,{})]}),v.jsx(iD,{})]}):v.jsxs("div",{className:"app__home-navbar",children:[v.jsx(bg,{}),v.jsx(Aa,{to:"/paronAB/auth",className:"app__topbar-login",children:"Logga in"})]})}),v.jsxs(bI,{children:[v.jsx(tr,{path:"/paronAB/",element:v.jsx(jg,{authUser:t})}),v.jsx(tr,{path:"/paronAB/auth",element:v.jsx(Sw,{})}),v.jsx(tr,{path:"/paronAB/update-stock",element:v.jsx(Zx,{})}),v.jsx(tr,{path:"/paronAB/create-stock",element:v.jsx(tD,{})}),v.jsx(tr,{path:"/paronAB/history",element:v.jsx(rD,{})}),v.jsx(tr,{path:"*",element:v.jsx(jg,{authUser:t})})]})]})})}Ac.createRoot(document.getElementById("root")).render(v.jsx(Xg.StrictMode,{children:v.jsx(oD,{})}));
